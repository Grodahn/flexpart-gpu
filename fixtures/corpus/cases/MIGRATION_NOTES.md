...
| - | `ldrydep/lwetdep/ldecay` | **Not part of schema v2.** FLEXPART 11.1 does not expose these as COMMAND namelist keys and the generator never wrote them. Dry/wet deposition and decay are represented through `physics_switches`, species physics contracts and release/deposition data; these pseudo-fields are rejected as unknown. |
