...
| 5 | DECAY-011 analytic decay | — | Per-species decay kernel and forcing lane exist, but no paired corpus run or complete decayed-reservoir budget | Oracle supports `PDECAY` half-life (`examples/Nuclear/SPECIES/SPECIES_021`, Xe-133 453168 s) | No paired run | None | **Blocked.** Future gate: `exp(-lambda t)`, `lambda=ln2/half-life`, with decayed reservoir. Must not be reported as passed. |
